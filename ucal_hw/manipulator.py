...
class Manipulator(Manipulator4AxBase):
    x = Cpt(DeadbandEpicsMotor, "SampX}Mtr", name="Manipulator X", kind='hinted')
    y = Cpt(DeadbandEpicsMotor, "SampY}Mtr",  name="Manipulator Y", kind='hinted')
    z = Cpt(DeadbandEpicsMotor, "SampZ}Mtr",  name="Manipulator Z", kind='hinted')
    r = Cpt(DeadbandEpicsMotor, "SampTh}Mtr", name="Manipulator R", kind='hinted')
